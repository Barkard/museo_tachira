...
export default function Create() {
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Clasificaciones', href: '/clasificaciones' }, { title: 'Nueva', href: '#' }]}>
            <Head title="Nueva Clasificación" />
            <div className="p-4 max-w-xl mx-auto">
                <div className="bg-white p-8 rounded-lg shadow border">
                    <h2 className="text-2xl font-bold mb-6">Nueva Clasificación</h2>
