                ...
                <div className="max-w-3xl mx-auto w-full bg-white p-8 rounded-lg shadow-sm border border-gray-200">
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="bg-blue-50/50 p-6 rounded-lg border border-blue-100 space-y-6">
                            ...
                            <div>
                                <label className="block text-sm mb-1 font-bold text-blue-700 underline decoration-blue-500/30">Ubicación Inicial (Sala / Depósito) *</label>
                                <select
                                    required
                                    className="w-full px-4 py-2 rounded-md focus:ring-2 focus:ring-blue-500 outline-none bg-white font-medium text-gray-900 border-2 border-blue-400/50"
