...
export default function Edit({ movement, movementTypes, agents, statuses }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        movement_type_id: movement.movement_type_id.toString(),
        agent_id: movement.agent_id.toString(),
        transaction_status_id: movement.transaction_status_id.toString(),
        entry_exit_date: movement.entry_exit_date || '',
    });
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <div className="max-w-2xl mx-auto w-full bg-white p-8 rounded-lg shadow-sm border border-gray-200">
                    <h2 className="text-2xl font-bold text-gray-800 mb-6">Editar Movimiento</h2>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="flex justify-end gap-3 pt-6">
                            ...
                            >
                                {processing ? 'Actualizar Movimiento' : 'Guardar Cambios'}
                            </button>
                        </div>
                    </form>
                </div>
